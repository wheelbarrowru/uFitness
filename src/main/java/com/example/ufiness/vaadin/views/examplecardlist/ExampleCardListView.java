package com.example.ufiness.vaadin.views.examplecardlist;
...
@PageTitle("Example Card List")
@Route(value = "example-card-list")
@AnonymousAllowed
public class ExampleCardListView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ExampleCardListView() {
        addClassName("example-card-list-view");
        setSizeFull();
        grid.setHeight("100%");
